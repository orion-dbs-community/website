...
[Sesame Open Science](collections/sos/) and [InSySPo Campinas](collections/insyspo/) provide the full [OpenAIRE Graph Dataset](collections/sos/#openaire) in different schemas.
:::
:::
...
Many collections provide time-specfic snapshots of OpenAlex data, including [CWTS](collections/cwts/), [InSySPo Campinas](collections/insyspo/), [MultiObs](collections/multiobs) and [SUB Göttingen](collections/subugoe/).
:::
:::
...
Persistent identifier for researchers, linking individuals to their works, affiliations, and funding.
