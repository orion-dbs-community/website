...
- Copy `_template.qmd` to a new folder under `projects/` and save it as `index.qmd`. Use your collection's acronym as the folder name.
...
- The site builds automatically using GitHub Actions. If a dataset or table isn't publicly available, the build will fail. 
