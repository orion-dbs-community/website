...
You can also check our [Events](events.qmd) page for upcoming talks and meetings, or browse the [Tools](tools.qmd) built around these collections.

## FORCE11 Working Group

A growing set of actors are hosting large research information datasets in shared spaces, notably in Google BigQuery. Our [FORCE11 working group](force11.qmd) coordinates amongst current contributors and works towards community standards for discovery, processing, preservation and documentation.
